...
| How-to | [Version and publish Maven artifacts to Nexus](docs/how-to/develop/release-and-deploy-server-streampack.md), [configure deployment environment](docs/how-to/deploy/configure-env.md), [build and publish the container](docs/how-to/deploy/build-and-publish-container.md) |
