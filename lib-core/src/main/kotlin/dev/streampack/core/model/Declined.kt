 ...
 * [OperationService][dev.streampack.core.service.OperationService] logs the decline with operation
 * context, so the operation itself only needs to provide the reason.
 */
